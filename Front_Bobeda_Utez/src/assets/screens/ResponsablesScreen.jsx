  ...
  return (
    <div>
      ...
      <div className="header-container">
        <h2 className="mb-3">Responsables</h2>
        <button
      ...
      <div className="container mt-5">
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">Editar Responsable</h5>
                  <button
                    type="button"
                    className="btn-close"
                  ...
                  <form>
                    ...
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        className="form-control"
                        name="telefono"
                        value={selectedResource.telefono}
                        onChange={handleChange}
                      />
                    </div>
                    <div className="mb-3">
        ...
        <div className="modal fade" id="addModal" tabIndex="-1">
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">Agregar Nuevo Responsable</h5>
                <button
                  type="button"
                  className="btn-close"
                  data-bs-dismiss="modal"
